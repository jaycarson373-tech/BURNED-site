...
if(config.siteUrl||process.env.VERCEL_URL){const url=new URL(config.siteUrl||'https://'+process.env.VERCEL_URL).origin;html=html.replace('</head>',`<link rel="canonical" href="${url}/"><meta property="og:url" content="${url}/"><meta property="og:image" content="${url}/topblast-banner.png"><meta name="twitter:image" content="${url}/topblast-banner.png"></head>`);}
